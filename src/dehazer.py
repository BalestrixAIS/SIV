...
# Refine the transmission map through the Guided Filtering method
...
if __name__ == "__main__":
    image_path = "data/fogged/fog2.jpg"
    image, dark_channel, transmission, dehazed_image = dehaze_image(image_path)

    #cv2.imshow("Original Image",  cv2.cvtColor((image * 255).astype(np.uint8), cv2.COLOR_RGB2BGR))
